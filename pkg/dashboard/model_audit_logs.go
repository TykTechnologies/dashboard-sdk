...
// checks if the AuditLogs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuditLogs{}
...
func (o AuditLogs) ToMap() (map[string]interface{}, error) {
