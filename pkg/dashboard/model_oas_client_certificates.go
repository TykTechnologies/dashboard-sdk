...
// checks if the OasClientCertificates type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OasClientCertificates{}

// OasClientCertificates struct for OasClientCertificates
type OasClientCertificates struct {
...
func (o OasClientCertificates) MarshalJSON() ([]byte, error) {
...
func (o OasClientCertificates) ToMap() (map[string]interface{}, error) {
...
type NullableOasClientCertificates struct {
	value *OasClientCertificates
	isSet bool
}

func (v NullableOasClientCertificates) Get() *OasClientCertificates {
	return v.value
}

func (v *NullableOasClientCertificates) Set(val *OasClientCertificates) {
	v.value = val
	v.isSet = true
}

func (v NullableOasClientCertificates) IsSet() bool {
	return v.isSet
}

func (v *NullableOasClientCertificates) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOasClientCertificates(val *OasClientCertificates) *NullableOasClientCertificates {
	return &NullableOasClientCertificates{value: val, isSet: true}
}

func (v NullableOasClientCertificates) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOasClientCertificates) UnmarshalJSON(src []byte) error {
	v.isSet = true
