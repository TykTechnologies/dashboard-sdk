...
func (o *ApiDefinition) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
// SetOas gets a reference to the given OasOAS and assigns it to the Oas field.
...
func (o *ApiDefinition) SetUpdatedAtNil() {
	o.UpdatedAt.Set(nil)
}
