...
type DetailedExampleAPIMetadata struct {
	ApiDefinition *ApidefAPIDefinition `json:"api_definition,omitempty"`
...
func (o *DetailedExampleAPIMetadata) GetApiDefinition() ApidefAPIDefinition {
	if o == nil || IsNil(o.ApiDefinition) {
		var ret ApidefAPIDefinition
		return ret
	}
...
func (o *DetailedExampleAPIMetadata) GetApiDefinitionOk() (*ApidefAPIDefinition, bool) {
	if o == nil || IsNil(o.ApiDefinition) {
		return nil, false
	}
...
// SetApiDefinition gets a reference to the given ApidefAPIDefinition and assigns it to the ApiDefinition field.
func (o *DetailedExampleAPIMetadata) SetApiDefinition(v ApidefAPIDefinition) {
	o.ApiDefinition = &v
}
