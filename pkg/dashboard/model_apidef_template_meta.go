...
// checks if the ApidefTemplateMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefTemplateMeta{}

// ApidefTemplateMeta struct for ApidefTemplateMeta
type ApidefTemplateMeta struct {
	Disabled     *bool               `json:"disabled,omitempty"`
	Method       *string             `json:"method,omitempty"`
	Path         *string             `json:"path,omitempty"`
	TemplateData *ApidefTemplateData `json:"template_data,omitempty"`
}
...
// SetTemplateData gets a reference to the given ApidefTemplateData and assigns it to the TemplateData field.
func (o *ApidefTemplateMeta) SetTemplateData(v ApidefTemplateData) {
	o.TemplateData = &v
}

func (o ApidefTemplateMeta) MarshalJSON() ([]byte, error) {
...
func (o ApidefTemplateMeta) ToMap() (map[string]interface{}, error) {
...
type NullableApidefTemplateMeta struct {
	value *ApidefTemplateMeta
	isSet bool
}

func (v NullableApidefTemplateMeta) Get() *ApidefTemplateMeta {
	return v.value
}

func (v *NullableApidefTemplateMeta) Set(val *ApidefTemplateMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefTemplateMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefTemplateMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefTemplateMeta(val *ApidefTemplateMeta) *NullableApidefTemplateMeta {
	return &NullableApidefTemplateMeta{value: val, isSet: true}
}

func (v NullableApidefTemplateMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefTemplateMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
