...
// checks if the CreateStreamsApiRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateStreamsApiRequest{}

// CreateStreamsApiRequest struct for CreateStreamsApiRequest
type CreateStreamsApiRequest struct {
	...
	XTykStreaming  *XTykStreamingXTykStreaming `json:"x-tyk-streaming,omitempty"`
}

type _CreateStreamsApiRequest CreateStreamsApiRequest
...
// GetXTykStreaming returns the XTykStreaming field value if set, zero value otherwise.
func (o *CreateStreamsApiRequest) GetXTykStreaming() XTykStreamingXTykStreaming {
	if o == nil || IsNil(o.XTykStreaming) {
		var ret XTykStreamingXTykStreaming
		return ret
	}
	return *o.XTykStreaming
}

// GetXTykStreamingOk returns a tuple with the XTykStreaming field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateStreamsApiRequest) GetXTykStreamingOk() (*XTykStreamingXTykStreaming, bool) {
	if o == nil || IsNil(o.XTykStreaming) {
		return nil, false
	}
	return o.XTykStreaming, true
}
...
// SetXTykStreaming gets a reference to the given XTykStreamingXTykStreaming and assigns it to the XTykStreaming field.
func (o *CreateStreamsApiRequest) SetXTykStreaming(v XTykStreamingXTykStreaming) {
	o.XTykStreaming = &v
}

func (o CreateStreamsApiRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateStreamsApiRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.XTykStreaming) {
		toSerialize["x-tyk-streaming"] = o.XTykStreaming
	}
	return toSerialize, nil
}

func (o *CreateStreamsApiRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateStreamsApiRequest := _CreateStreamsApiRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateStreamsApiRequest)

	if err != nil {
		return err
	}

	*o = CreateStreamsApiRequest(varCreateStreamsApiRequest)

	return err
}

type NullableCreateStreamsApiRequest struct {
	value *CreateStreamsApiRequest
	isSet bool
}

func (v NullableCreateStreamsApiRequest) Get() *CreateStreamsApiRequest {
	return v.value
}

func (v *NullableCreateStreamsApiRequest) Set(val *CreateStreamsApiRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateStreamsApiRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateStreamsApiRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateStreamsApiRequest(val *CreateStreamsApiRequest) *NullableCreateStreamsApiRequest {
	return &NullableCreateStreamsApiRequest{value: val, isSet: true}
}

func (v NullableCreateStreamsApiRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateStreamsApiRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
