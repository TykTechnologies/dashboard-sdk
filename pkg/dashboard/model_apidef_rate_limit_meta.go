...
// checks if the ApidefRateLimitMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefRateLimitMeta{}

// ApidefRateLimitMeta struct for ApidefRateLimitMeta
type ApidefRateLimitMeta struct {
...
func (o ApidefRateLimitMeta) MarshalJSON() ([]byte, error) {
...
func (o ApidefRateLimitMeta) ToMap() (map[string]interface{}, error) {
...
type NullableApidefRateLimitMeta struct {
	value *ApidefRateLimitMeta
	isSet bool
}

func (v NullableApidefRateLimitMeta) Get() *ApidefRateLimitMeta {
	return v.value
}

func (v *NullableApidefRateLimitMeta) Set(val *ApidefRateLimitMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefRateLimitMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefRateLimitMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefRateLimitMeta(val *ApidefRateLimitMeta) *NullableApidefRateLimitMeta {
	return &NullableApidefRateLimitMeta{value: val, isSet: true}
}

func (v NullableApidefRateLimitMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefRateLimitMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
