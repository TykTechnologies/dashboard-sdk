...
// checks if the OasCustomPlugin type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OasCustomPlugin{}

// OasCustomPlugin struct for OasCustomPlugin
type OasCustomPlugin struct {
...
func (o OasCustomPlugin) MarshalJSON() ([]byte, error) {
...
func (o OasCustomPlugin) ToMap() (map[string]interface{}, error) {
...
type NullableOasCustomPlugin struct {
	value *OasCustomPlugin
	isSet bool
}

func (v NullableOasCustomPlugin) Get() *OasCustomPlugin {
	return v.value
}

func (v *NullableOasCustomPlugin) Set(val *OasCustomPlugin) {
	v.value = val
	v.isSet = true
}

func (v NullableOasCustomPlugin) IsSet() bool {
	return v.isSet
}

func (v *NullableOasCustomPlugin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOasCustomPlugin(val *OasCustomPlugin) *NullableOasCustomPlugin {
	return &NullableOasCustomPlugin{value: val, isSet: true}
}

func (v NullableOasCustomPlugin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOasCustomPlugin) UnmarshalJSON(src []byte) error {
	v.isSet = true
