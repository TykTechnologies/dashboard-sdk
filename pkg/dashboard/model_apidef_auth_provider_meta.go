...
// checks if the ApidefAuthProviderMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefAuthProviderMeta{}

// ApidefAuthProviderMeta struct for ApidefAuthProviderMeta
type ApidefAuthProviderMeta struct {
...
func (o ApidefAuthProviderMeta) MarshalJSON() ([]byte, error) {
...
func (o ApidefAuthProviderMeta) ToMap() (map[string]interface{}, error) {
...
type NullableApidefAuthProviderMeta struct {
	value *ApidefAuthProviderMeta
	isSet bool
}

func (v NullableApidefAuthProviderMeta) Get() *ApidefAuthProviderMeta {
	return v.value
}

func (v *NullableApidefAuthProviderMeta) Set(val *ApidefAuthProviderMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefAuthProviderMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefAuthProviderMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefAuthProviderMeta(val *ApidefAuthProviderMeta) *NullableApidefAuthProviderMeta {
	return &NullableApidefAuthProviderMeta{value: val, isSet: true}
}

func (v NullableApidefAuthProviderMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefAuthProviderMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
