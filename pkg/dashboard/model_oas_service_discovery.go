...
// checks if the OasServiceDiscovery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OasServiceDiscovery{}

// OasServiceDiscovery struct for OasServiceDiscovery
type OasServiceDiscovery struct {
	Cache               *OasServiceDiscoveryCache `json:"cache,omitempty"`
...
func (o *OasServiceDiscovery) GetCache() OasServiceDiscoveryCache {
	if o == nil || IsNil(o.Cache) {
		var ret OasServiceDiscoveryCache
		return ret
	}
	return *o.Cache
}
...
// SetCache gets a reference to the given OasServiceDiscoveryCache and assigns it to the Cache field.
...
func (o OasServiceDiscovery) MarshalJSON() ([]byte, error) {
...
func (o OasServiceDiscovery) ToMap() (map[string]interface{}, error) {
...
type NullableOasServiceDiscovery struct {
	value *OasServiceDiscovery
	isSet bool
}

func (v NullableOasServiceDiscovery) Get() *OasServiceDiscovery {
	return v.value
}

func (v *NullableOasServiceDiscovery) Set(val *OasServiceDiscovery) {
	v.value = val
	v.isSet = true
}

func (v NullableOasServiceDiscovery) IsSet() bool {
	return v.isSet
}

func (v *NullableOasServiceDiscovery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOasServiceDiscovery(val *OasServiceDiscovery) *NullableOasServiceDiscovery {
	return &NullableOasServiceDiscovery{value: val, isSet: true}
}

func (v NullableOasServiceDiscovery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOasServiceDiscovery) UnmarshalJSON(src []byte) error {
	v.isSet = true
