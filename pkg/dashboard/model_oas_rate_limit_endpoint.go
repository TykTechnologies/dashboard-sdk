...
// checks if the OasRateLimitEndpoint type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OasRateLimitEndpoint{}

// OasRateLimitEndpoint struct for OasRateLimitEndpoint
type OasRateLimitEndpoint struct {
...
func (o OasRateLimitEndpoint) MarshalJSON() ([]byte, error) {
...
func (o OasRateLimitEndpoint) ToMap() (map[string]interface{}, error) {
...
type NullableOasRateLimitEndpoint struct {
	value *OasRateLimitEndpoint
	isSet bool
}

func (v NullableOasRateLimitEndpoint) Get() *OasRateLimitEndpoint {
	return v.value
}

func (v *NullableOasRateLimitEndpoint) Set(val *OasRateLimitEndpoint) {
	v.value = val
	v.isSet = true
}

func (v NullableOasRateLimitEndpoint) IsSet() bool {
	return v.isSet
}

func (v *NullableOasRateLimitEndpoint) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOasRateLimitEndpoint(val *OasRateLimitEndpoint) *NullableOasRateLimitEndpoint {
	return &NullableOasRateLimitEndpoint{value: val, isSet: true}
}

func (v NullableOasRateLimitEndpoint) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOasRateLimitEndpoint) UnmarshalJSON(src []byte) error {
	v.isSet = true
