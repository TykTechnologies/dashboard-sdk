...
// checks if the ApidefProxyConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefProxyConfig{}

// ApidefProxyConfig struct for ApidefProxyConfig
type ApidefProxyConfig struct {
	...
	Transport                   *ApidefProxyConfigTransport          `json:"transport,omitempty"`
}
...
func (o *ApidefProxyConfig) GetTransport() ApidefProxyConfigTransport {
	if o == nil || IsNil(o.Transport) {
		var ret ApidefProxyConfigTransport
		return ret
	}
	return *o.Transport
}
...
// SetTransport gets a reference to the given ApidefProxyConfigTransport and assigns it to the Transport field.
func (o *ApidefProxyConfig) SetTransport(v ApidefProxyConfigTransport) {
	o.Transport = &v
}

func (o ApidefProxyConfig) MarshalJSON() ([]byte, error) {
...
func (o ApidefProxyConfig) ToMap() (map[string]interface{}, error) {
...
type NullableApidefProxyConfig struct {
	value *ApidefProxyConfig
	isSet bool
}

func (v NullableApidefProxyConfig) Get() *ApidefProxyConfig {
	return v.value
}

func (v *NullableApidefProxyConfig) Set(val *ApidefProxyConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefProxyConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefProxyConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefProxyConfig(val *ApidefProxyConfig) *NullableApidefProxyConfig {
	return &NullableApidefProxyConfig{value: val, isSet: true}
}

func (v NullableApidefProxyConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefProxyConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
