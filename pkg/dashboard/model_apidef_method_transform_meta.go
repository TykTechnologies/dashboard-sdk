...
// checks if the ApidefMethodTransformMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefMethodTransformMeta{}

// ApidefMethodTransformMeta struct for ApidefMethodTransformMeta
type ApidefMethodTransformMeta struct {
...
func NewApidefMethodTransformMeta() *ApidefMethodTransformMeta {
	this := ApidefMethodTransformMeta{}
	return &this
}
...
func (o ApidefMethodTransformMeta) MarshalJSON() ([]byte, error) {
...
func (o ApidefMethodTransformMeta) ToMap() (map[string]interface{}, error) {
...
type NullableApidefMethodTransformMeta struct {
	value *ApidefMethodTransformMeta
	isSet bool
}

func (v NullableApidefMethodTransformMeta) Get() *ApidefMethodTransformMeta {
	return v.value
}

func (v *NullableApidefMethodTransformMeta) Set(val *ApidefMethodTransformMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefMethodTransformMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefMethodTransformMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefMethodTransformMeta(val *ApidefMethodTransformMeta) *NullableApidefMethodTransformMeta {
	return &NullableApidefMethodTransformMeta{value: val, isSet: true}
}

func (v NullableApidefMethodTransformMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefMethodTransformMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
