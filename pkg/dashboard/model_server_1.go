...
type Server1 struct {
	...
	Variables   *map[string]ServerVariable1 `json:"variables,omitempty"`
}
...
func (o *Server1) GetVariables() map[string]ServerVariable1 {
	if o == nil || IsNil(o.Variables) {
		var ret map[string]ServerVariable1
		return ret
	}
	return *o.Variables
}
...
// SetVariables gets a reference to the given map[string]ServerVariable1 and assigns it to the Variables field.
