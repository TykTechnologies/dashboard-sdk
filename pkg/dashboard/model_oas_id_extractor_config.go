...
// checks if the OasIDExtractorConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OasIDExtractorConfig{}

// OasIDExtractorConfig struct for OasIDExtractorConfig
type OasIDExtractorConfig struct {
...
func (o OasIDExtractorConfig) MarshalJSON() ([]byte, error) {
...
func (o OasIDExtractorConfig) ToMap() (map[string]interface{}, error) {
...
type NullableOasIDExtractorConfig struct {
	value *OasIDExtractorConfig
	isSet bool
}

func (v NullableOasIDExtractorConfig) Get() *OasIDExtractorConfig {
	return v.value
}

func (v *NullableOasIDExtractorConfig) Set(val *OasIDExtractorConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableOasIDExtractorConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableOasIDExtractorConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOasIDExtractorConfig(val *OasIDExtractorConfig) *NullableOasIDExtractorConfig {
	return &NullableOasIDExtractorConfig{value: val, isSet: true}
}

func (v NullableOasIDExtractorConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOasIDExtractorConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
