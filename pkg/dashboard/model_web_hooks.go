...
type WebHooks struct {
	Hooks []WebHookHandlerConf `json:"hooks,omitempty"`
...
// GetHooks returns the Hooks field value if set, zero value otherwise (both if not set or set to explicit null).
...
// SetHooks gets a reference to the given []WebHookHandlerConf and assigns it to the Hooks field.
