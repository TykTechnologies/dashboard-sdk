...
func Test_dashboard_KeysAPIService(t *testing.T) {
	...
	t.Run("Test KeysAPIService CreateBasicAuthUser", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var username string

		resp, httpRes, err := apiClient.KeysAPI.CreateBasicAuthUser(context.Background(), username).Execute()
