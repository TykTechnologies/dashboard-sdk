...
type PoliciesAPI interface {
	...
	*/
	...
	//  @return ApiError
	DeletePolicyExecute(r ApiDeletePolicyRequest) (*ApiError, *http.Response, error)

	/*
		GetPolicies List Portal Policies
	...
	*/
	...
	//  @return ApiError
	PostPoliciesExecute(r ApiPostPoliciesRequest) (*ApiError, *http.Response, error)
	...
	*/
	...
	//  @return ApiError
	PutPoliciesExecute(r ApiPutPoliciesRequest) (*ApiError, *http.Response, error)

	/*
		SearchPolicies Search List of Policies

		Search List of Policies. If query parameter q is a policy id it will look for policies that have the given id. However if q i not a policy ID it will return policies with whose name matches the patten based via q query parameter.If the send a policy id in query parameter q and also send query parameter policy_ids,only policy_ids will be used for searching
...
func (r ApiDeletePolicyRequest) Execute() (*ApiError, *http.Response, error) {
...
//
//	@return ApiError
func (a *PoliciesAPIService) DeletePolicyExecute(r ApiDeletePolicyRequest) (*ApiError, *http.Response, error) {
	var (
...
func (r ApiPostPoliciesRequest) Execute() (*ApiError, *http.Response, error) {
...
//
//	@return ApiError
func (a *PoliciesAPIService) PostPoliciesExecute(r ApiPostPoliciesRequest) (*ApiError, *http.Response, error) {
	var (
...
func (r ApiPutPoliciesRequest) Execute() (*ApiError, *http.Response, error) {
...
//
//	@return ApiError
func (a *PoliciesAPIService) PutPoliciesExecute(r ApiPutPoliciesRequest) (*ApiError, *http.Response, error) {
	var (
...
// Comma separete list of Api IDs.Return only policy that that have the given api ids in their access_right
...
func (a *PoliciesAPIService) SearchPoliciesExecute(r ApiSearchPoliciesRequest) (*ReturnDataStruct, *http.Response, error) {
	...
	if r.policyIds != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "policy_ids", r.policyIds, "")
	}
	if r.active != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "active", r.active, "")
	}
