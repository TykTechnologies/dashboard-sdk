...
// checks if the UserGroups type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserGroups{}

// UserGroups struct for UserGroups
...
func (o UserGroups) MarshalJSON() ([]byte, error) {
...
func (o UserGroups) ToMap() (map[string]interface{}, error) {
...
type NullableUserGroups struct {
	value *UserGroups
	isSet bool
}

func (v NullableUserGroups) Get() *UserGroups {
	return v.value
}

func (v *NullableUserGroups) Set(val *UserGroups) {
	v.value = val
	v.isSet = true
}

func (v NullableUserGroups) IsSet() bool {
	return v.isSet
}

func (v *NullableUserGroups) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserGroups(val *UserGroups) *NullableUserGroups {
	return &NullableUserGroups{value: val, isSet: true}
}

func (v NullableUserGroups) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserGroups) UnmarshalJSON(src []byte) error {
	v.isSet = true
