...
// checks if the ApidefJWTValidation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefJWTValidation{}

// ApidefJWTValidation struct for ApidefJWTValidation
type ApidefJWTValidation struct {
...
func (o *ApidefJWTValidation) GetSigningMethod() string {
...
func (o ApidefJWTValidation) MarshalJSON() ([]byte, error) {
...
func (o ApidefJWTValidation) ToMap() (map[string]interface{}, error) {
...
type NullableApidefJWTValidation struct {
	value *ApidefJWTValidation
	isSet bool
}

func (v NullableApidefJWTValidation) Get() *ApidefJWTValidation {
	return v.value
}

func (v *NullableApidefJWTValidation) Set(val *ApidefJWTValidation) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefJWTValidation) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefJWTValidation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefJWTValidation(val *ApidefJWTValidation) *NullableApidefJWTValidation {
	return &NullableApidefJWTValidation{value: val, isSet: true}
}

func (v NullableApidefJWTValidation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefJWTValidation) UnmarshalJSON(src []byte) error {
	v.isSet = true
