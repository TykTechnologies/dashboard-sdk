...
type CertsAPI interface {
	...
	/*
		CreateCertificates Create Certificate
	...
	*/
	...
	/*
		...
		This api will remove the certificates from any apis that contains it as an upstream certificates or as a client certificate.It will also remove any key that uses this certs
	...
	*/
	...
	//  @return ApiError
	DeleteCertificateDependenciesExecute(r ApiDeleteCertificateDependenciesRequest) (*ApiError, *http.Response, error)
	...
	*/
	...
	/*
		...
		Return list of certificates.If you send the mode query parameter with the value `detailed` the certificates returned will be more detailed(Will contains all certs basic details).To retrieve a list with all the certificate details use [this endpoint](#operation/listDetailedCertificates).If the mode query parameter is omitted or is empty this endpoint will only return the certificates ids.The list of certificates returned is paginated.
...
Upload new SSL certificate in PEM format(you should upload as a file). If the certificate should have a private key, convert both the public certificate and the associated private key to PEM format and concatenate them to a single file.You can only upload one certificate at a time
	...
	@return ApiCreateCertificatesRequest
*/
func (a *CertsAPIService) CreateCertificates(ctx context.Context) ApiCreateCertificatesRequest {
	return ApiCreateCertificatesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return APICertificateStatusMessage
func (a *CertsAPIService) CreateCertificatesExecute(r ApiCreateCertificatesRequest) (*APICertificateStatusMessage, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CertsAPIService.CreateCertificates")
	if err != nil {
...
func (r ApiDeleteCertificateDependenciesRequest) Execute() (*ApiError, *http.Response, error) {
...
This api will remove the certificates from any apis that contains it as an upstream certificates or as a client certificate.It will also remove any key that uses this certs
	...
	@return ApiDeleteCertificateDependenciesRequest
*/
func (a *CertsAPIService) DeleteCertificateDependencies(ctx context.Context, certId string) ApiDeleteCertificateDependenciesRequest {
	return ApiDeleteCertificateDependenciesRequest{
		ApiService: a,
		ctx:        ctx,
		certId:     certId,
...
//
//	@return ApiError
func (a *CertsAPIService) DeleteCertificateDependenciesExecute(r ApiDeleteCertificateDependenciesRequest) (*ApiError, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CertsAPIService.DeleteCertificateDependencies")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
Delete certificate by their id
	...
	@return ApiDeleteCertificatesRequest
*/
func (a *CertsAPIService) DeleteCertificates(ctx context.Context, certId string) ApiDeleteCertificatesRequest {
	return ApiDeleteCertificatesRequest{
		ApiService: a,
		ctx:        ctx,
		certId:     certId,
...
//
//	@return ApiStatusMessage
func (a *CertsAPIService) DeleteCertificatesExecute(r ApiDeleteCertificatesRequest) (*ApiStatusMessage, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CertsAPIService.DeleteCertificates")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
Get a single certificate details with the certificate's ID
	...
	@return ApiGetCertificateRequest
*/
func (a *CertsAPIService) GetCertificate(ctx context.Context, certId string) ApiGetCertificateRequest {
	return ApiGetCertificateRequest{
		ApiService: a,
		ctx:        ctx,
		certId:     certId,
...
//
//	@return CertsCertificateMeta
func (a *CertsAPIService) GetCertificateExecute(r ApiGetCertificateRequest) (*CertsCertificateMeta, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CertsAPIService.GetCertificate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
This will return the API IDS and API names of all apis that uses this certificates as either upstream certificates or as client certificates.
	...
	@return ApiGetCertificateDependenciesRequest
*/
func (a *CertsAPIService) GetCertificateDependencies(ctx context.Context, certId string) ApiGetCertificateDependenciesRequest {
	return ApiGetCertificateDependenciesRequest{
		ApiService: a,
		ctx:        ctx,
		certId:     certId,
...
//
//	@return CertificateDependencies
func (a *CertsAPIService) GetCertificateDependenciesExecute(r ApiGetCertificateDependenciesRequest) (*CertificateDependencies, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CertsAPIService.GetCertificateDependencies")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// Set to detailed to get certificates that are more detailed(Will contains certs basic details).To retrieve a list of certificates with all the certificate details use [this endpoint](#operation/listDetailedCertificates)
...
Return list of certificates.If you send the mode query parameter with the value `detailed` the certificates returned will be more detailed(Will contains all certs basic details).To retrieve a list with all the certificate details use [this endpoint](#operation/listDetailedCertificates).If the mode query parameter is omitted or is empty this endpoint will only return the certificates ids.The list of certificates returned is paginated.
	...
	@return ApiListCertificatesRequest
*/
func (a *CertsAPIService) ListCertificates(ctx context.Context) ApiListCertificatesRequest {
	return ApiListCertificatesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return ListCertificates200Response
func (a *CertsAPIService) ListCertificatesExecute(r ApiListCertificatesRequest) (*ListCertificates200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CertsAPIService.ListCertificates")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
Return a list that contains certificates and their full details.
	...
	@return ApiListDetailedCertificatesRequest
*/
func (a *CertsAPIService) ListDetailedCertificates(ctx context.Context) ApiListDetailedCertificatesRequest {
	return ApiListDetailedCertificatesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return CertificateDetailedList
func (a *CertsAPIService) ListDetailedCertificatesExecute(r ApiListDetailedCertificatesRequest) (*CertificateDetailedList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CertsAPIService.ListDetailedCertificates")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
