...
// checks if the OasTest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OasTest{}

// OasTest struct for OasTest
type OasTest struct {
...
func (o OasTest) MarshalJSON() ([]byte, error) {
...
func (o OasTest) ToMap() (map[string]interface{}, error) {
...
type NullableOasTest struct {
	value *OasTest
	isSet bool
}

func (v NullableOasTest) Get() *OasTest {
	return v.value
}

func (v *NullableOasTest) Set(val *OasTest) {
	v.value = val
	v.isSet = true
}

func (v NullableOasTest) IsSet() bool {
	return v.isSet
}

func (v *NullableOasTest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOasTest(val *OasTest) *NullableOasTest {
	return &NullableOasTest{value: val, isSet: true}
}

func (v NullableOasTest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOasTest) UnmarshalJSON(src []byte) error {
	v.isSet = true
