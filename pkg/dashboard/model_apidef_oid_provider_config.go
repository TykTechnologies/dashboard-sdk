...
// checks if the ApidefOIDProviderConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefOIDProviderConfig{}

// ApidefOIDProviderConfig struct for ApidefOIDProviderConfig
type ApidefOIDProviderConfig struct {
...
func (o ApidefOIDProviderConfig) MarshalJSON() ([]byte, error) {
...
func (o ApidefOIDProviderConfig) ToMap() (map[string]interface{}, error) {
...
type NullableApidefOIDProviderConfig struct {
	value *ApidefOIDProviderConfig
	isSet bool
}

func (v NullableApidefOIDProviderConfig) Get() *ApidefOIDProviderConfig {
	return v.value
}

func (v *NullableApidefOIDProviderConfig) Set(val *ApidefOIDProviderConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefOIDProviderConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefOIDProviderConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefOIDProviderConfig(val *ApidefOIDProviderConfig) *NullableApidefOIDProviderConfig {
	return &NullableApidefOIDProviderConfig{value: val, isSet: true}
}

func (v NullableApidefOIDProviderConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefOIDProviderConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
