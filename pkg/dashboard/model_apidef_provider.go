...
// checks if the ApidefProvider type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefProvider{}

// ApidefProvider struct for ApidefProvider
type ApidefProvider struct {
	Introspection *ApidefIntrospection `json:"introspection,omitempty"`
	Jwt           *ApidefJWTValidation `json:"jwt,omitempty"`
}
...
// SetIntrospection gets a reference to the given ApidefIntrospection and assigns it to the Introspection field.
...
// SetJwt gets a reference to the given ApidefJWTValidation and assigns it to the Jwt field.
func (o *ApidefProvider) SetJwt(v ApidefJWTValidation) {
	o.Jwt = &v
}

func (o ApidefProvider) MarshalJSON() ([]byte, error) {
...
func (o ApidefProvider) ToMap() (map[string]interface{}, error) {
...
type NullableApidefProvider struct {
	value *ApidefProvider
	isSet bool
}

func (v NullableApidefProvider) Get() *ApidefProvider {
	return v.value
}

func (v *NullableApidefProvider) Set(val *ApidefProvider) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefProvider) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefProvider) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefProvider(val *ApidefProvider) *NullableApidefProvider {
	return &NullableApidefProvider{value: val, isSet: true}
}

func (v NullableApidefProvider) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefProvider) UnmarshalJSON(src []byte) error {
	v.isSet = true
