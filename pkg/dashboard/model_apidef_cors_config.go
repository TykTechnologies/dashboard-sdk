...
// checks if the ApidefCORSConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefCORSConfig{}

// ApidefCORSConfig struct for ApidefCORSConfig
type ApidefCORSConfig struct {
...
func (o ApidefCORSConfig) MarshalJSON() ([]byte, error) {
...
func (o ApidefCORSConfig) ToMap() (map[string]interface{}, error) {
...
type NullableApidefCORSConfig struct {
	value *ApidefCORSConfig
	isSet bool
}

func (v NullableApidefCORSConfig) Get() *ApidefCORSConfig {
	return v.value
}

func (v *NullableApidefCORSConfig) Set(val *ApidefCORSConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefCORSConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefCORSConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefCORSConfig(val *ApidefCORSConfig) *NullableApidefCORSConfig {
	return &NullableApidefCORSConfig{value: val, isSet: true}
}

func (v NullableApidefCORSConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefCORSConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
