...
// checks if the ApidefMockResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefMockResponseMeta{}

// ApidefMockResponseMeta struct for ApidefMockResponseMeta
type ApidefMockResponseMeta struct {
...
func (o *ApidefMockResponseMeta) GetHeaders() map[string]string {
	if o == nil {
...
func (o ApidefMockResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o ApidefMockResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableApidefMockResponseMeta struct {
	value *ApidefMockResponseMeta
	isSet bool
}

func (v NullableApidefMockResponseMeta) Get() *ApidefMockResponseMeta {
	return v.value
}

func (v *NullableApidefMockResponseMeta) Set(val *ApidefMockResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefMockResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefMockResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefMockResponseMeta(val *ApidefMockResponseMeta) *NullableApidefMockResponseMeta {
	return &NullableApidefMockResponseMeta{value: val, isSet: true}
}

func (v NullableApidefMockResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefMockResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
