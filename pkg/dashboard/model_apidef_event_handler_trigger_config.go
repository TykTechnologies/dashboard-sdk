...
// checks if the ApidefEventHandlerTriggerConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefEventHandlerTriggerConfig{}

// ApidefEventHandlerTriggerConfig struct for ApidefEventHandlerTriggerConfig
type ApidefEventHandlerTriggerConfig struct {
...
func NewApidefEventHandlerTriggerConfig() *ApidefEventHandlerTriggerConfig {
	this := ApidefEventHandlerTriggerConfig{}
	return &this
}
...
func (o ApidefEventHandlerTriggerConfig) MarshalJSON() ([]byte, error) {
...
func (o ApidefEventHandlerTriggerConfig) ToMap() (map[string]interface{}, error) {
...
type NullableApidefEventHandlerTriggerConfig struct {
	value *ApidefEventHandlerTriggerConfig
	isSet bool
}

func (v NullableApidefEventHandlerTriggerConfig) Get() *ApidefEventHandlerTriggerConfig {
	return v.value
}

func (v *NullableApidefEventHandlerTriggerConfig) Set(val *ApidefEventHandlerTriggerConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefEventHandlerTriggerConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefEventHandlerTriggerConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefEventHandlerTriggerConfig(val *ApidefEventHandlerTriggerConfig) *NullableApidefEventHandlerTriggerConfig {
	return &NullableApidefEventHandlerTriggerConfig{value: val, isSet: true}
}

func (v NullableApidefEventHandlerTriggerConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefEventHandlerTriggerConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
