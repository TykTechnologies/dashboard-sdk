...
type ResultUnit struct {
	...
	MaxUpstreamLatency *int64     `json:"max_upstream_latency,omitempty"`
	MinLatency         *int64     `json:"min_latency,omitempty"`
	MinUpstreamLatency *int64     `json:"min_upstream_latency,omitempty"`
...
// SetMaxLatency gets a reference to the given int64 and assigns it to the MaxLatency field.
...
// SetMaxUpstreamLatency gets a reference to the given int64 and assigns it to the MaxUpstreamLatency field.
...
// SetMinLatency gets a reference to the given int64 and assigns it to the MinLatency field.
...
// SetMinUpstreamLatency gets a reference to the given int64 and assigns it to the MinUpstreamLatency field.
...
// SetRequestTime gets a reference to the given float64 and assigns it to the RequestTime field.
...
// SetUpstreamLatency gets a reference to the given float64 and assigns it to the UpstreamLatency field.
