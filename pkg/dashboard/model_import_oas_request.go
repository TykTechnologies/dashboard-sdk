...
func ApiImportByUrlPayloadAsImportOASRequest(v *ApiImportByUrlPayload) ImportOASRequest {
...
func (dst *ImportOASRequest) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data failed to match schemas in oneOf(ImportOASRequest)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ImportOASRequest) MarshalJSON() ([]byte, error) {
...
func (obj *ImportOASRequest) GetActualInstance() interface{} {
	if obj == nil {
		return nil
	}
...
type NullableImportOASRequest struct {
	value *ImportOASRequest
	isSet bool
}

func (v NullableImportOASRequest) Get() *ImportOASRequest {
	return v.value
}

func (v *NullableImportOASRequest) Set(val *ImportOASRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableImportOASRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableImportOASRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImportOASRequest(val *ImportOASRequest) *NullableImportOASRequest {
	return &NullableImportOASRequest{value: val, isSet: true}
}

func (v NullableImportOASRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImportOASRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
