...
// checks if the ReturnDataStruct type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReturnDataStruct{}

// ReturnDataStruct struct for ReturnDataStruct
...
func (o ReturnDataStruct) MarshalJSON() ([]byte, error) {
...
func (o ReturnDataStruct) ToMap() (map[string]interface{}, error) {
...
type NullableReturnDataStruct struct {
	value *ReturnDataStruct
	isSet bool
}

func (v NullableReturnDataStruct) Get() *ReturnDataStruct {
	return v.value
}

func (v *NullableReturnDataStruct) Set(val *ReturnDataStruct) {
	v.value = val
	v.isSet = true
}

func (v NullableReturnDataStruct) IsSet() bool {
	return v.isSet
}

func (v *NullableReturnDataStruct) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReturnDataStruct(val *ReturnDataStruct) *NullableReturnDataStruct {
	return &NullableReturnDataStruct{value: val, isSet: true}
}

func (v NullableReturnDataStruct) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReturnDataStruct) UnmarshalJSON(src []byte) error {
	v.isSet = true
