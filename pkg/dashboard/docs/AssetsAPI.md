...
> ApiResponse AddAsset(ctx).AddAssetRequest(addAssetRequest).Execute()
...
func main() {
	...
	// response from `AddAsset`: ApiResponse
...
> ApiResponse DeleteAsset(ctx, assetID).Execute()
...
func main() {
	...
	// response from `DeleteAsset`: ApiResponse
...
> ApiResponse UpdateAsset(ctx, assetID).AddAssetRequest(addAssetRequest).Execute()
...
func main() {
	...
	// response from `UpdateAsset`: ApiResponse
