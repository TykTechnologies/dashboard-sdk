...
------------ | ------------- | ------------- | -------------
**Mid** | Pointer to **string** | a unique identifier assigned by Tyk when the template is registered in the Dashboard database | [optional] 
**Data** | Pointer to **map[string]interface{}** |  | [optional] 
**Description** | Pointer to **string** |  a short description of the template, that could be used for example to indicate the configuration held within the template | [optional] 
**Id** | Pointer to **string** | a unique string type identifier for the template | [optional] 
**Kind** | Pointer to **string** | the asset type, which is set to oas-template | [optional] 
