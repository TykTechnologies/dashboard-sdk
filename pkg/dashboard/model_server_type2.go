...
// checks if the ServerType2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServerType2{}

// ServerType2 struct for ServerType2
type ServerType2 struct {
...
func (o ServerType2) MarshalJSON() ([]byte, error) {
...
func (o ServerType2) ToMap() (map[string]interface{}, error) {
...
type NullableServerType2 struct {
	value *ServerType2
	isSet bool
}

func (v NullableServerType2) Get() *ServerType2 {
	return v.value
}

func (v *NullableServerType2) Set(val *ServerType2) {
	v.value = val
	v.isSet = true
}

func (v NullableServerType2) IsSet() bool {
	return v.isSet
}

func (v *NullableServerType2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServerType2(val *ServerType2) *NullableServerType2 {
	return &NullableServerType2{value: val, isSet: true}
}

func (v NullableServerType2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServerType2) UnmarshalJSON(src []byte) error {
	v.isSet = true
