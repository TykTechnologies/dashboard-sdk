...
type Info1 struct {
	...
	License        *License1 `json:"license,omitempty"`
...
// SetContact gets a reference to the given Contact1 and assigns it to the Contact field.
...
// SetLicense gets a reference to the given License1 and assigns it to the License field.
