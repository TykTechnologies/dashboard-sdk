...
type APIsAPI interface {
	...
	*/
	...
	//  @return ApiResponse
	DeleteApiExecute(r ApiDeleteApiRequest) (*ApiResponse, *http.Response, error)
	...
	*/
	...
	//  @return ApiDefinitionWrapper
	GetApiExecute(r ApiGetApiRequest) (*ApiDefinitionWrapper, *http.Response, error)
	...
	*/
	...
	/*
		...
		This will return your API BasePath(your API listen path) ,Host(your API domain or gateway hostname ) and API URL (full url to your API upstream which is a combination of the protocol the API uses (e.g http)+ host name(e.g tyk.io) and the API listen_path )
	...
	*/
	...
	//  @return ApiDefinitionsResponse
	GetApisExecute(r ApiGetApisRequest) (*ApiDefinitionsResponse, *http.Response, error)
	...
	*/
	...
	//  @return ApiResponse
	PostApisExecute(r ApiPostApisRequest) (*ApiResponse, *http.Response, error)
	...
	*/
	...
	//  @return ApiResponse
	PutApiExecute(r ApiPutApiRequest) (*ApiResponse, *http.Response, error)
	...
	*/
	...
	//  @return ApiDefinitionsResponse
	SearchApisExecute(r ApiSearchApisRequest) (*ApiDefinitionsResponse, *http.Response, error)
	...
	*/
	...
	//  @return ApiResponse
	UpdateApiAccessRightsExecute(r ApiUpdateApiAccessRightsRequest) (*ApiResponse, *http.Response, error)
}
...
func (r ApiDeleteApiRequest) Execute() (*ApiResponse, *http.Response, error) {
...
//
//	@return ApiResponse
func (a *APIsAPIService) DeleteApiExecute(r ApiDeleteApiRequest) (*ApiResponse, *http.Response, error) {
	var (
...
func (r ApiGetAPIExampleRequest) Readme(readme bool) ApiGetAPIExampleRequest {
	r.readme = &readme
	return r
}
...
func (a *APIsAPIService) GetAPIExampleExecute(r ApiGetAPIExampleRequest) (*DetailedExampleAPIMetadata, *http.Response, error) {
	...
	if r.readme != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "readme", r.readme, "form", "")
	} else {
		var defaultValue bool = false
		r.readme = &defaultValue
	}
	if r.apiDef != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "apiDef", r.apiDef, "form", "")
	} else {
		var defaultValue bool = false
	...
	if r.xTykExamplesIndex != nil {
		parameterAddToHeaderOrQuery(localVarHeaderParams, "x-tyk-examples-index", r.xTykExamplesIndex, "simple", "")
	}
	if r.xTykRepoUrl != nil {
		parameterAddToHeaderOrQuery(localVarHeaderParams, "x-tyk-repo-url", r.xTykRepoUrl, "simple", "")
	}
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
...
func (r ApiGetApiRequest) Execute() (*ApiDefinitionWrapper, *http.Response, error) {
...
//
//	@return ApiDefinitionWrapper
func (a *APIsAPIService) GetApiExecute(r ApiGetApiRequest) (*ApiDefinitionWrapper, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ApiDefinitionWrapper
	)
...
// * &#39;name&#39; - Sort by name in ascending order. * &#39;-name&#39; - Sort by name in descending order. * &#39;updated_at&#39; - Sort by updated_at in ascending order. * &#39;-updated_at&#39; - Sort by updated_at in descending order. * &#39;created_at&#39; - Sort by created_at in ascending order. * &#39;-created_at&#39; - Sort by created_at in descending order.
func (r ApiGetApisRequest) Sort(sort string) ApiGetApisRequest {
	r.sort = &sort
	return r
}

func (r ApiGetApisRequest) Execute() (*ApiDefinitionsResponse, *http.Response, error) {
...
//
//	@return ApiDefinitionsResponse
func (a *APIsAPIService) GetApisExecute(r ApiGetApisRequest) (*ApiDefinitionsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ApiDefinitionsResponse
	)
	...
	if r.compressed != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "compressed", r.compressed, "form", "")
	}
	if r.apiType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "api_type", r.apiType, "form", "")
	}
	if r.category != nil {
	...
	if r.baseApis != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "base_apis", r.baseApis, "form", "")
	}
	if r.q != nil {
...
type ApiPostApisRequest struct {
	...
	setDefault           *bool
	apiDefinitionWrapper *ApiDefinitionWrapper
}
...
func (r ApiPostApisRequest) ApiDefinitionWrapper(apiDefinitionWrapper ApiDefinitionWrapper) ApiPostApisRequest {
	r.apiDefinitionWrapper = &apiDefinitionWrapper
	return r
}

func (r ApiPostApisRequest) Execute() (*ApiResponse, *http.Response, error) {
...
//
//	@return ApiResponse
func (a *APIsAPIService) PostApisExecute(r ApiPostApisRequest) (*ApiResponse, *http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = r.apiDefinitionWrapper
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r ApiPutApiRequest) ApiDefinitionWrapper(apiDefinitionWrapper ApiDefinitionWrapper) ApiPutApiRequest {
	r.apiDefinitionWrapper = &apiDefinitionWrapper
	return r
}

func (r ApiPutApiRequest) Execute() (*ApiResponse, *http.Response, error) {
...
//
//	@return ApiResponse
func (a *APIsAPIService) PutApiExecute(r ApiPutApiRequest) (*ApiResponse, *http.Response, error) {
	var (
...
func (r ApiSearchApisRequest) Execute() (*ApiDefinitionsResponse, *http.Response, error) {
...
//
//	@return ApiDefinitionsResponse
func (a *APIsAPIService) SearchApisExecute(r ApiSearchApisRequest) (*ApiDefinitionsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiUpdateApiAccessRightsRequest) Execute() (*ApiResponse, *http.Response, error) {
...
//
//	@return ApiResponse
func (a *APIsAPIService) UpdateApiAccessRightsExecute(r ApiUpdateApiAccessRightsRequest) (*ApiResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
