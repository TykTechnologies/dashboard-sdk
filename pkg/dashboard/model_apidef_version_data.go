...
// checks if the ApidefVersionData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefVersionData{}

// ApidefVersionData struct for ApidefVersionData
type ApidefVersionData struct {
	DefaultVersion *string                      `json:"default_version,omitempty"`
	NotVersioned   *bool                        `json:"not_versioned,omitempty"`
	Versions       map[string]ApidefVersionInfo `json:"versions,omitempty"`
}
...
func (o *ApidefVersionData) GetVersions() map[string]ApidefVersionInfo {
	if o == nil {
		var ret map[string]ApidefVersionInfo
		return ret
	}
	return o.Versions
}
...
// SetVersions gets a reference to the given map[string]ApidefVersionInfo and assigns it to the Versions field.
func (o *ApidefVersionData) SetVersions(v map[string]ApidefVersionInfo) {
	o.Versions = v
}

func (o ApidefVersionData) MarshalJSON() ([]byte, error) {
...
func (o ApidefVersionData) ToMap() (map[string]interface{}, error) {
...
type NullableApidefVersionData struct {
	value *ApidefVersionData
	isSet bool
}

func (v NullableApidefVersionData) Get() *ApidefVersionData {
	return v.value
}

func (v *NullableApidefVersionData) Set(val *ApidefVersionData) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefVersionData) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefVersionData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefVersionData(val *ApidefVersionData) *NullableApidefVersionData {
	return &NullableApidefVersionData{value: val, isSet: true}
}

func (v NullableApidefVersionData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefVersionData) UnmarshalJSON(src []byte) error {
	v.isSet = true
