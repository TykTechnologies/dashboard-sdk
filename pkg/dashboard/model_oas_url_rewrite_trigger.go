...
// checks if the OasURLRewriteTrigger type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OasURLRewriteTrigger{}

// OasURLRewriteTrigger struct for OasURLRewriteTrigger
type OasURLRewriteTrigger struct {
	Condition *string             `json:"condition,omitempty"`
	RewriteTo *string             `json:"rewriteTo,omitempty"`
	Rules     []OasURLRewriteRule `json:"rules,omitempty"`
}
...
// SetRules gets a reference to the given []OasURLRewriteRule and assigns it to the Rules field.
func (o *OasURLRewriteTrigger) SetRules(v []OasURLRewriteRule) {
	o.Rules = v
}

func (o OasURLRewriteTrigger) MarshalJSON() ([]byte, error) {
...
func (o OasURLRewriteTrigger) ToMap() (map[string]interface{}, error) {
...
type NullableOasURLRewriteTrigger struct {
	value *OasURLRewriteTrigger
	isSet bool
}

func (v NullableOasURLRewriteTrigger) Get() *OasURLRewriteTrigger {
	return v.value
}

func (v *NullableOasURLRewriteTrigger) Set(val *OasURLRewriteTrigger) {
	v.value = val
	v.isSet = true
}

func (v NullableOasURLRewriteTrigger) IsSet() bool {
	return v.isSet
}

func (v *NullableOasURLRewriteTrigger) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOasURLRewriteTrigger(val *OasURLRewriteTrigger) *NullableOasURLRewriteTrigger {
	return &NullableOasURLRewriteTrigger{value: val, isSet: true}
}

func (v NullableOasURLRewriteTrigger) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOasURLRewriteTrigger) UnmarshalJSON(src []byte) error {
	v.isSet = true
