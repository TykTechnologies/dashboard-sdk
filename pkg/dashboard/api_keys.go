...
type KeysAPI interface {
	...
	*/
	...
	/*
		...
		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@param username  Username of Basic Auth user to create or update.
	...
	*/
	...
	//  @return KeyData
	CreateBasicAuthUserExecute(r ApiCreateBasicAuthUserRequest) (*KeyData, *http.Response, error)
	...
	*/
	...
	//  @return ApiError
	DeleteApiKeyDetailExecute(r ApiDeleteApiKeyDetailRequest) (*ApiError, *http.Response, error)
	...
	*/
	...
	//  @return ApiError
	DeleteKeyExecute(r ApiDeleteKeyRequest) (*ApiError, *http.Response, error)
	...
	*/
	...
	/*
		...
		List all the keys and all the keys details.If `q` query parameter is passed it will only return keys whose key_id contain the passed text.
	...
	*/
	...
	/*
		ValidateAKeyDefinition This will validate key a definition
...
func (a *KeysAPIService) AddKeyExecute(r ApiAddKeyRequest) (*KeyData, *http.Response, error) {
	...
	if r.basicAuth != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "basic_auth", r.basicAuth, "")
	} else {
...
func (r ApiCreateBasicAuthUserRequest) Execute() (*KeyData, *http.Response, error) {
...
Create a Basic Auth user with the username specified in the path {username}.Note you have to send password via(the basic_auth_data.password field) in the request body
	...
	@return ApiCreateBasicAuthUserRequest
*/
func (a *KeysAPIService) CreateBasicAuthUser(ctx context.Context, username string) ApiCreateBasicAuthUserRequest {
	return ApiCreateBasicAuthUserRequest{
		ApiService: a,
		ctx:        ctx,
		username:   username,
...
//
//	@return KeyData
func (a *KeysAPIService) CreateBasicAuthUserExecute(r ApiCreateBasicAuthUserRequest) (*KeyData, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KeysAPIService.CreateBasicAuthUser")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiDeleteApiKeyDetailRequest) Execute() (*ApiError, *http.Response, error) {
...
//
//	@return ApiError
func (a *KeysAPIService) DeleteApiKeyDetailExecute(r ApiDeleteApiKeyDetailRequest) (*ApiError, *http.Response, error) {
	var (
	...
	if r.autoGuess != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "auto_guess", r.autoGuess, "")
	} else {
		var defaultValue bool = false
...
func (r ApiDeleteKeyRequest) Execute() (*ApiError, *http.Response, error) {
...
//
//	@return ApiError
func (a *KeysAPIService) DeleteKeyExecute(r ApiDeleteKeyRequest) (*ApiError, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
...
// Filter and return all keys that contain this text in there key_id
