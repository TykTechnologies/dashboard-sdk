...
// checks if the OasCORS type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OasCORS{}

// OasCORS struct for OasCORS
type OasCORS struct {
...
func (o OasCORS) MarshalJSON() ([]byte, error) {
...
func (o OasCORS) ToMap() (map[string]interface{}, error) {
...
type NullableOasCORS struct {
	value *OasCORS
	isSet bool
}

func (v NullableOasCORS) Get() *OasCORS {
	return v.value
}

func (v *NullableOasCORS) Set(val *OasCORS) {
	v.value = val
	v.isSet = true
}

func (v NullableOasCORS) IsSet() bool {
	return v.isSet
}

func (v *NullableOasCORS) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOasCORS(val *OasCORS) *NullableOasCORS {
	return &NullableOasCORS{value: val, isSet: true}
}

func (v NullableOasCORS) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOasCORS) UnmarshalJSON(src []byte) error {
	v.isSet = true
