...
// checks if the OasTransformHeaders type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OasTransformHeaders{}

// OasTransformHeaders struct for OasTransformHeaders
type OasTransformHeaders struct {
	Add     []OasHeader `json:"add,omitempty"`
...
// SetAdd gets a reference to the given []OasHeader and assigns it to the Add field.
...
func (o OasTransformHeaders) MarshalJSON() ([]byte, error) {
...
func (o OasTransformHeaders) ToMap() (map[string]interface{}, error) {
...
type NullableOasTransformHeaders struct {
	value *OasTransformHeaders
	isSet bool
}

func (v NullableOasTransformHeaders) Get() *OasTransformHeaders {
	return v.value
}

func (v *NullableOasTransformHeaders) Set(val *OasTransformHeaders) {
	v.value = val
	v.isSet = true
}

func (v NullableOasTransformHeaders) IsSet() bool {
	return v.isSet
}

func (v *NullableOasTransformHeaders) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOasTransformHeaders(val *OasTransformHeaders) *NullableOasTransformHeaders {
	return &NullableOasTransformHeaders{value: val, isSet: true}
}

func (v NullableOasTransformHeaders) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOasTransformHeaders) UnmarshalJSON(src []byte) error {
	v.isSet = true
