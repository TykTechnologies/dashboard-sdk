...
// checks if the ApidefStringRegexMap type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefStringRegexMap{}

// ApidefStringRegexMap struct for ApidefStringRegexMap
type ApidefStringRegexMap struct {
...
func (o ApidefStringRegexMap) MarshalJSON() ([]byte, error) {
...
func (o ApidefStringRegexMap) ToMap() (map[string]interface{}, error) {
...
type NullableApidefStringRegexMap struct {
	value *ApidefStringRegexMap
	isSet bool
}

func (v NullableApidefStringRegexMap) Get() *ApidefStringRegexMap {
	return v.value
}

func (v *NullableApidefStringRegexMap) Set(val *ApidefStringRegexMap) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefStringRegexMap) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefStringRegexMap) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefStringRegexMap(val *ApidefStringRegexMap) *NullableApidefStringRegexMap {
	return &NullableApidefStringRegexMap{value: val, isSet: true}
}

func (v NullableApidefStringRegexMap) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefStringRegexMap) UnmarshalJSON(src []byte) error {
	v.isSet = true
