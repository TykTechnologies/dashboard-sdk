...
// checks if the ApidefGoPluginMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefGoPluginMeta{}

// ApidefGoPluginMeta struct for ApidefGoPluginMeta
type ApidefGoPluginMeta struct {
...
func (o ApidefGoPluginMeta) MarshalJSON() ([]byte, error) {
...
func (o ApidefGoPluginMeta) ToMap() (map[string]interface{}, error) {
...
type NullableApidefGoPluginMeta struct {
	value *ApidefGoPluginMeta
	isSet bool
}

func (v NullableApidefGoPluginMeta) Get() *ApidefGoPluginMeta {
	return v.value
}

func (v *NullableApidefGoPluginMeta) Set(val *ApidefGoPluginMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefGoPluginMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefGoPluginMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefGoPluginMeta(val *ApidefGoPluginMeta) *NullableApidefGoPluginMeta {
	return &NullableApidefGoPluginMeta{value: val, isSet: true}
}

func (v NullableApidefGoPluginMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefGoPluginMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
