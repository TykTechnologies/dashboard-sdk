...
// checks if the ApidefValidateRequestMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefValidateRequestMeta{}

// ApidefValidateRequestMeta struct for ApidefValidateRequestMeta
type ApidefValidateRequestMeta struct {
...
func NewApidefValidateRequestMeta() *ApidefValidateRequestMeta {
	this := ApidefValidateRequestMeta{}
	return &this
}
...
func (o ApidefValidateRequestMeta) MarshalJSON() ([]byte, error) {
...
func (o ApidefValidateRequestMeta) ToMap() (map[string]interface{}, error) {
...
type NullableApidefValidateRequestMeta struct {
	value *ApidefValidateRequestMeta
	isSet bool
}

func (v NullableApidefValidateRequestMeta) Get() *ApidefValidateRequestMeta {
	return v.value
}

func (v *NullableApidefValidateRequestMeta) Set(val *ApidefValidateRequestMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefValidateRequestMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefValidateRequestMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefValidateRequestMeta(val *ApidefValidateRequestMeta) *NullableApidefValidateRequestMeta {
	return &NullableApidefValidateRequestMeta{value: val, isSet: true}
}

func (v NullableApidefValidateRequestMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefValidateRequestMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
