...
// checks if the ApidefMiddlewareDefinition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefMiddlewareDefinition{}

// ApidefMiddlewareDefinition struct for ApidefMiddlewareDefinition
type ApidefMiddlewareDefinition struct {
...
func NewApidefMiddlewareDefinition() *ApidefMiddlewareDefinition {
	this := ApidefMiddlewareDefinition{}
	return &this
}
...
func (o ApidefMiddlewareDefinition) MarshalJSON() ([]byte, error) {
...
func (o ApidefMiddlewareDefinition) ToMap() (map[string]interface{}, error) {
...
type NullableApidefMiddlewareDefinition struct {
	value *ApidefMiddlewareDefinition
	isSet bool
}

func (v NullableApidefMiddlewareDefinition) Get() *ApidefMiddlewareDefinition {
	return v.value
}

func (v *NullableApidefMiddlewareDefinition) Set(val *ApidefMiddlewareDefinition) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefMiddlewareDefinition) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefMiddlewareDefinition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefMiddlewareDefinition(val *ApidefMiddlewareDefinition) *NullableApidefMiddlewareDefinition {
	return &NullableApidefMiddlewareDefinition{value: val, isSet: true}
}

func (v NullableApidefMiddlewareDefinition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefMiddlewareDefinition) UnmarshalJSON(src []byte) error {
	v.isSet = true
