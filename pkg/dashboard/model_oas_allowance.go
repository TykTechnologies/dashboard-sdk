...
// checks if the OasAllowance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OasAllowance{}

// OasAllowance struct for OasAllowance
type OasAllowance struct {
...
func (o OasAllowance) MarshalJSON() ([]byte, error) {
...
func (o OasAllowance) ToMap() (map[string]interface{}, error) {
...
type NullableOasAllowance struct {
	value *OasAllowance
	isSet bool
}

func (v NullableOasAllowance) Get() *OasAllowance {
	return v.value
}

func (v *NullableOasAllowance) Set(val *OasAllowance) {
	v.value = val
	v.isSet = true
}

func (v NullableOasAllowance) IsSet() bool {
	return v.isSet
}

func (v *NullableOasAllowance) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOasAllowance(val *OasAllowance) *NullableOasAllowance {
	return &NullableOasAllowance{value: val, isSet: true}
}

func (v NullableOasAllowance) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOasAllowance) UnmarshalJSON(src []byte) error {
	v.isSet = true
