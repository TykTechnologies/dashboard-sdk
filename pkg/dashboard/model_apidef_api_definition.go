...
// checks if the ApidefAPIDefinition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefAPIDefinition{}

// ApidefAPIDefinition struct for ApidefAPIDefinition
type ApidefAPIDefinition struct {
	CORS                                 *ApidefCORSConfig             `json:"CORS,omitempty"`
	Active                               *bool                         `json:"active,omitempty"`
	AllowedIps                           []string                      `json:"allowed_ips,omitempty"`
	AnalyticsPlugin                      *ApidefAnalyticsPluginConfig  `json:"analytics_plugin,omitempty"`
	ApiId                                *string                       `json:"api_id,omitempty"`
	Auth                                 *ApidefAuthConfig             `json:"auth,omitempty"`
	AuthConfigs                          map[string]ApidefAuthConfig   `json:"auth_configs,omitempty"`
	AuthProvider                         *ApidefAuthProviderMeta       `json:"auth_provider,omitempty"`
	BaseIdentityProvidedBy               *string                       `json:"base_identity_provided_by,omitempty"`
	BasicAuth                            *ApidefAPIDefinitionBasicAuth `json:"basic_auth,omitempty"`
	BlacklistedIps                       []string                      `json:"blacklisted_ips,omitempty"`
	CacheOptions                         *ApidefCacheOptions           `json:"cache_options,omitempty"`
	...
	CustomMiddleware                     *ApidefMiddlewareSection      `json:"custom_middleware,omitempty"`
	...
	Definition                           *ApidefVersionDefinition      `json:"definition,omitempty"`
	...
	EventHandlers                        *ApidefEventHandlerMetaConfig `json:"event_handlers,omitempty"`
	Expiration                           *string                       `json:"expiration,omitempty"`
	ExpireAnalyticsAfter                 *int32                        `json:"expire_analytics_after,omitempty"`
	ExternalOauth                        *ApidefExternalOAuth          `json:"external_oauth,omitempty"`
	GlobalRateLimit                      *ApidefGlobalRateLimit        `json:"global_rate_limit,omitempty"`
	Graphql                              *ApidefGraphQLConfig          `json:"graphql,omitempty"`
	...
	Notifications                        *ApidefNotificationsManager   `json:"notifications,omitempty"`
	OauthMeta                            *ApidefAPIDefinitionOauthMeta `json:"oauth_meta,omitempty"`
	OpenidOptions                        *ApidefOpenIDOptions          `json:"openid_options,omitempty"`
	OrgId                                *string                       `json:"org_id,omitempty"`
	PinnedPublicKeys                     map[string]string             `json:"pinned_public_keys,omitempty"`
	Protocol                             *string                       `json:"protocol,omitempty"`
	Proxy                                *ApidefProxyConfig            `json:"proxy,omitempty"`
	RequestSigning                       *ApidefRequestSigningMeta     `json:"request_signing,omitempty"`
	ResponseProcessors                   []ApidefResponseProcessor     `json:"response_processors,omitempty"`
	Scopes                               *ApidefScopes                 `json:"scopes,omitempty"`
	...
	SessionProvider                      *ApidefSessionProviderMeta    `json:"session_provider,omitempty"`
	...
	UptimeTests                          *ApidefUptimeTests            `json:"uptime_tests,omitempty"`
	...
	VersionData                          *ApidefVersionData            `json:"version_data,omitempty"`
}
...
// SetCORS gets a reference to the given ApidefCORSConfig and assigns it to the CORS field.
...
func (o *ApidefAPIDefinition) GetAnalyticsPlugin() ApidefAnalyticsPluginConfig {
	if o == nil || IsNil(o.AnalyticsPlugin) {
		var ret ApidefAnalyticsPluginConfig
		return ret
	}
...
// SetAnalyticsPlugin gets a reference to the given ApidefAnalyticsPluginConfig and assigns it to the AnalyticsPlugin field.
...
// SetAuth gets a reference to the given ApidefAuthConfig and assigns it to the Auth field.
...
func (o *ApidefAPIDefinition) GetAuthConfigs() map[string]ApidefAuthConfig {
	if o == nil {
		var ret map[string]ApidefAuthConfig
		return ret
	}
...
// SetAuthConfigs gets a reference to the given map[string]ApidefAuthConfig and assigns it to the AuthConfigs field.
...
func (o *ApidefAPIDefinition) GetAuthProvider() ApidefAuthProviderMeta {
	if o == nil || IsNil(o.AuthProvider) {
		var ret ApidefAuthProviderMeta
		return ret
	}
...
// SetAuthProvider gets a reference to the given ApidefAuthProviderMeta and assigns it to the AuthProvider field.
...
func (o *ApidefAPIDefinition) GetBasicAuth() ApidefAPIDefinitionBasicAuth {
	if o == nil || IsNil(o.BasicAuth) {
		var ret ApidefAPIDefinitionBasicAuth
		return ret
	}
	return *o.BasicAuth
}
...
// SetBasicAuth gets a reference to the given ApidefAPIDefinitionBasicAuth and assigns it to the BasicAuth field.
...
// SetCacheOptions gets a reference to the given ApidefCacheOptions and assigns it to the CacheOptions field.
...
func (o *ApidefAPIDefinition) GetCustomMiddleware() ApidefMiddlewareSection {
	if o == nil || IsNil(o.CustomMiddleware) {
		var ret ApidefMiddlewareSection
		return ret
	}
...
// SetCustomMiddleware gets a reference to the given ApidefMiddlewareSection and assigns it to the CustomMiddleware field.
...
func (o *ApidefAPIDefinition) GetDefinition() ApidefVersionDefinition {
	if o == nil || IsNil(o.Definition) {
		var ret ApidefVersionDefinition
		return ret
	}
	return *o.Definition
}
...
// SetDefinition gets a reference to the given ApidefVersionDefinition and assigns it to the Definition field.
...
func (o *ApidefAPIDefinition) GetEventHandlers() ApidefEventHandlerMetaConfig {
	if o == nil || IsNil(o.EventHandlers) {
		var ret ApidefEventHandlerMetaConfig
		return ret
	}
...
// SetEventHandlers gets a reference to the given ApidefEventHandlerMetaConfig and assigns it to the EventHandlers field.
...
// SetExternalOauth gets a reference to the given ApidefExternalOAuth and assigns it to the ExternalOauth field.
...
// SetGlobalRateLimit gets a reference to the given ApidefGlobalRateLimit and assigns it to the GlobalRateLimit field.
...
// SetGraphql gets a reference to the given ApidefGraphQLConfig and assigns it to the Graphql field.
...
func (o *ApidefAPIDefinition) GetNotifications() ApidefNotificationsManager {
	if o == nil || IsNil(o.Notifications) {
		var ret ApidefNotificationsManager
		return ret
	}
...
// SetNotifications gets a reference to the given ApidefNotificationsManager and assigns it to the Notifications field.
...
func (o *ApidefAPIDefinition) GetOauthMeta() ApidefAPIDefinitionOauthMeta {
	if o == nil || IsNil(o.OauthMeta) {
		var ret ApidefAPIDefinitionOauthMeta
		return ret
	}
	return *o.OauthMeta
}
...
// SetOauthMeta gets a reference to the given ApidefAPIDefinitionOauthMeta and assigns it to the OauthMeta field.
...
// SetOpenidOptions gets a reference to the given ApidefOpenIDOptions and assigns it to the OpenidOptions field.
...
// SetProxy gets a reference to the given ApidefProxyConfig and assigns it to the Proxy field.
...
func (o *ApidefAPIDefinition) GetRequestSigning() ApidefRequestSigningMeta {
	if o == nil || IsNil(o.RequestSigning) {
		var ret ApidefRequestSigningMeta
		return ret
	}
...
// SetRequestSigning gets a reference to the given ApidefRequestSigningMeta and assigns it to the RequestSigning field.
...
func (o *ApidefAPIDefinition) GetResponseProcessors() []ApidefResponseProcessor {
	if o == nil {
		var ret []ApidefResponseProcessor
		return ret
	}
...
// SetResponseProcessors gets a reference to the given []ApidefResponseProcessor and assigns it to the ResponseProcessors field.
...
// SetScopes gets a reference to the given ApidefScopes and assigns it to the Scopes field.
...
func (o *ApidefAPIDefinition) GetSessionProvider() ApidefSessionProviderMeta {
	if o == nil || IsNil(o.SessionProvider) {
		var ret ApidefSessionProviderMeta
		return ret
	}
...
// SetSessionProvider gets a reference to the given ApidefSessionProviderMeta and assigns it to the SessionProvider field.
...
// SetUptimeTests gets a reference to the given ApidefUptimeTests and assigns it to the UptimeTests field.
...
// SetVersionData gets a reference to the given ApidefVersionData and assigns it to the VersionData field.
func (o *ApidefAPIDefinition) SetVersionData(v ApidefVersionData) {
	o.VersionData = &v
}

func (o ApidefAPIDefinition) MarshalJSON() ([]byte, error) {
...
func (o ApidefAPIDefinition) ToMap() (map[string]interface{}, error) {
...
type NullableApidefAPIDefinition struct {
	value *ApidefAPIDefinition
	isSet bool
}

func (v NullableApidefAPIDefinition) Get() *ApidefAPIDefinition {
	return v.value
}

func (v *NullableApidefAPIDefinition) Set(val *ApidefAPIDefinition) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefAPIDefinition) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefAPIDefinition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefAPIDefinition(val *ApidefAPIDefinition) *NullableApidefAPIDefinition {
	return &NullableApidefAPIDefinition{value: val, isSet: true}
}

func (v NullableApidefAPIDefinition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefAPIDefinition) UnmarshalJSON(src []byte) error {
	v.isSet = true
