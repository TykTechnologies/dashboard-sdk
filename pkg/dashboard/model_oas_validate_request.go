...
// checks if the OasValidateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OasValidateRequest{}

// OasValidateRequest struct for OasValidateRequest
type OasValidateRequest struct {
...
func (o OasValidateRequest) MarshalJSON() ([]byte, error) {
...
func (o OasValidateRequest) ToMap() (map[string]interface{}, error) {
...
type NullableOasValidateRequest struct {
	value *OasValidateRequest
	isSet bool
}

func (v NullableOasValidateRequest) Get() *OasValidateRequest {
	return v.value
}

func (v *NullableOasValidateRequest) Set(val *OasValidateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableOasValidateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableOasValidateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOasValidateRequest(val *OasValidateRequest) *NullableOasValidateRequest {
	return &NullableOasValidateRequest{value: val, isSet: true}
}

func (v NullableOasValidateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOasValidateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
