...
// checks if the ApidefHeaderInjectionMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefHeaderInjectionMeta{}

// ApidefHeaderInjectionMeta struct for ApidefHeaderInjectionMeta
type ApidefHeaderInjectionMeta struct {
...
func NewApidefHeaderInjectionMeta() *ApidefHeaderInjectionMeta {
	this := ApidefHeaderInjectionMeta{}
	return &this
}
...
func (o *ApidefHeaderInjectionMeta) HasActOn() bool {
	if o != nil && !IsNil(o.ActOn) {
		return true
	}
...
func (o ApidefHeaderInjectionMeta) MarshalJSON() ([]byte, error) {
...
func (o ApidefHeaderInjectionMeta) ToMap() (map[string]interface{}, error) {
...
type NullableApidefHeaderInjectionMeta struct {
	value *ApidefHeaderInjectionMeta
	isSet bool
}

func (v NullableApidefHeaderInjectionMeta) Get() *ApidefHeaderInjectionMeta {
	return v.value
}

func (v *NullableApidefHeaderInjectionMeta) Set(val *ApidefHeaderInjectionMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefHeaderInjectionMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefHeaderInjectionMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefHeaderInjectionMeta(val *ApidefHeaderInjectionMeta) *NullableApidefHeaderInjectionMeta {
	return &NullableApidefHeaderInjectionMeta{value: val, isSet: true}
}

func (v NullableApidefHeaderInjectionMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefHeaderInjectionMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
