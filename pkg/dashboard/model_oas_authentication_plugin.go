...
// checks if the OasAuthenticationPlugin type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OasAuthenticationPlugin{}

// OasAuthenticationPlugin struct for OasAuthenticationPlugin
type OasAuthenticationPlugin struct {
	Enabled      *bool           `json:"enabled,omitempty"`
	FunctionName *string         `json:"functionName,omitempty"`
	IdExtractor  *OasIDExtractor `json:"idExtractor,omitempty"`
...
// SetIdExtractor gets a reference to the given OasIDExtractor and assigns it to the IdExtractor field.
...
func (o OasAuthenticationPlugin) MarshalJSON() ([]byte, error) {
...
func (o OasAuthenticationPlugin) ToMap() (map[string]interface{}, error) {
...
type NullableOasAuthenticationPlugin struct {
	value *OasAuthenticationPlugin
	isSet bool
}

func (v NullableOasAuthenticationPlugin) Get() *OasAuthenticationPlugin {
	return v.value
}

func (v *NullableOasAuthenticationPlugin) Set(val *OasAuthenticationPlugin) {
	v.value = val
	v.isSet = true
}

func (v NullableOasAuthenticationPlugin) IsSet() bool {
	return v.isSet
}

func (v *NullableOasAuthenticationPlugin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOasAuthenticationPlugin(val *OasAuthenticationPlugin) *NullableOasAuthenticationPlugin {
	return &NullableOasAuthenticationPlugin{value: val, isSet: true}
}

func (v NullableOasAuthenticationPlugin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOasAuthenticationPlugin) UnmarshalJSON(src []byte) error {
	v.isSet = true
