...
type OASAPIsAPI interface {
	...
	/*
			...
			Create an API Definition in OAS format.
		The id and api_id fields in the definition are auto-generated by Tyk and cannot be set by the user.
	...
	*/
	...
	//  @return ListOASApiVersions200Response
	ListOASApiVersionsExecute(r ApiListOASApiVersionsRequest) (*ListOASApiVersions200Response, *http.Response, error)
...
func (a *OASAPIsAPIService) DownloadApisOASPublicExecute(r ApiDownloadApisOASPublicRequest) ([]OASSchemaResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/apis/oas/export"
...
func (r ApiListOASApiVersionsRequest) Execute() (*ListOASApiVersions200Response, *http.Response, error) {
...
//
//	@return ListOASApiVersions200Response
func (a *OASAPIsAPIService) ListOASApiVersionsExecute(r ApiListOASApiVersionsRequest) (*ListOASApiVersions200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ListOASApiVersions200Response
	)
