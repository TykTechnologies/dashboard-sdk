...
type AccessDefinition struct {
	...
	Endpoints            []SessionEndpoint       `json:"endpoints,omitempty"`
	FieldAccessRights    []FieldAccessDefinition `json:"field_access_rights,omitempty"`
	Limit                NullableAPILimit        `json:"limit,omitempty"`
...
// SetEndpoints gets a reference to the given []SessionEndpoint and assigns it to the Endpoints field.
...
// SetLimit gets a reference to the given NullableAPILimit and assigns it to the Limit field.
func (o *AccessDefinition) SetLimit(v APILimit) {
	o.Limit.Set(&v)
}

// SetLimitNil sets the value for Limit to be an explicit nil
func (o *AccessDefinition) SetLimitNil() {
	o.Limit.Set(nil)
}
