...
// checks if the OasRateLimit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OasRateLimit{}

// OasRateLimit struct for OasRateLimit
type OasRateLimit struct {
...
func (o OasRateLimit) MarshalJSON() ([]byte, error) {
...
func (o OasRateLimit) ToMap() (map[string]interface{}, error) {
...
type NullableOasRateLimit struct {
	value *OasRateLimit
	isSet bool
}

func (v NullableOasRateLimit) Get() *OasRateLimit {
	return v.value
}

func (v *NullableOasRateLimit) Set(val *OasRateLimit) {
	v.value = val
	v.isSet = true
}

func (v NullableOasRateLimit) IsSet() bool {
	return v.isSet
}

func (v *NullableOasRateLimit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOasRateLimit(val *OasRateLimit) *NullableOasRateLimit {
	return &NullableOasRateLimit{value: val, isSet: true}
}

func (v NullableOasRateLimit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOasRateLimit) UnmarshalJSON(src []byte) error {
	v.isSet = true
