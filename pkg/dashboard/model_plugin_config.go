...
type PluginConfig struct {
	Bundle NullablePluginBundle     `json:"bundle,omitempty"`
	Data   NullablePluginConfigData `json:"data,omitempty"`
...
// SetBundle gets a reference to the given NullablePluginBundle and assigns it to the Bundle field.
func (o *PluginConfig) SetBundle(v PluginBundle) {
	o.Bundle.Set(&v)
}

// SetBundleNil sets the value for Bundle to be an explicit nil
func (o *PluginConfig) SetBundleNil() {
	o.Bundle.Set(nil)
}
...
// SetData gets a reference to the given NullablePluginConfigData and assigns it to the Data field.
func (o *PluginConfig) SetData(v PluginConfigData) {
	o.Data.Set(&v)
}

// SetDataNil sets the value for Data to be an explicit nil
func (o *PluginConfig) SetDataNil() {
	o.Data.Set(nil)
}
