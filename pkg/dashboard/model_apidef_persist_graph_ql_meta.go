...
// checks if the ApidefPersistGraphQLMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefPersistGraphQLMeta{}

// ApidefPersistGraphQLMeta struct for ApidefPersistGraphQLMeta
type ApidefPersistGraphQLMeta struct {
...
func (o ApidefPersistGraphQLMeta) MarshalJSON() ([]byte, error) {
...
func (o ApidefPersistGraphQLMeta) ToMap() (map[string]interface{}, error) {
...
type NullableApidefPersistGraphQLMeta struct {
	value *ApidefPersistGraphQLMeta
	isSet bool
}

func (v NullableApidefPersistGraphQLMeta) Get() *ApidefPersistGraphQLMeta {
	return v.value
}

func (v *NullableApidefPersistGraphQLMeta) Set(val *ApidefPersistGraphQLMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefPersistGraphQLMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefPersistGraphQLMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefPersistGraphQLMeta(val *ApidefPersistGraphQLMeta) *NullableApidefPersistGraphQLMeta {
	return &NullableApidefPersistGraphQLMeta{value: val, isSet: true}
}

func (v NullableApidefPersistGraphQLMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefPersistGraphQLMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
