...
// checks if the OasEventHandler type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OasEventHandler{}

// OasEventHandler struct for OasEventHandler
type OasEventHandler struct {
...
func (o OasEventHandler) MarshalJSON() ([]byte, error) {
...
func (o OasEventHandler) ToMap() (map[string]interface{}, error) {
...
type NullableOasEventHandler struct {
	value *OasEventHandler
	isSet bool
}

func (v NullableOasEventHandler) Get() *OasEventHandler {
	return v.value
}

func (v *NullableOasEventHandler) Set(val *OasEventHandler) {
	v.value = val
	v.isSet = true
}

func (v NullableOasEventHandler) IsSet() bool {
	return v.isSet
}

func (v *NullableOasEventHandler) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOasEventHandler(val *OasEventHandler) *NullableOasEventHandler {
	return &NullableOasEventHandler{value: val, isSet: true}
}

func (v NullableOasEventHandler) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOasEventHandler) UnmarshalJSON(src []byte) error {
	v.isSet = true
