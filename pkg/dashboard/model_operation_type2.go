...
// checks if the OperationType2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OperationType2{}

// OperationType2 struct for OperationType2
type OperationType2 struct {
...
func (o *OperationType2) SetExternalDocsNil() {
...
func (o OperationType2) MarshalJSON() ([]byte, error) {
...
func (o OperationType2) ToMap() (map[string]interface{}, error) {
...
type NullableOperationType2 struct {
	value *OperationType2
	isSet bool
}

func (v NullableOperationType2) Get() *OperationType2 {
	return v.value
}

func (v *NullableOperationType2) Set(val *OperationType2) {
	v.value = val
	v.isSet = true
}

func (v NullableOperationType2) IsSet() bool {
	return v.isSet
}

func (v *NullableOperationType2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOperationType2(val *OperationType2) *NullableOperationType2 {
	return &NullableOperationType2{value: val, isSet: true}
}

func (v NullableOperationType2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOperationType2) UnmarshalJSON(src []byte) error {
	v.isSet = true
