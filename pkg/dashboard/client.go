...
// APIClient manages communication with the NEW Tyk DASH API API v5.4.0
...
type APIClient struct {
	...
	PortalAPICatalogueAPI PortalAPICatalogueAPI
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.PortalAPICatalogueAPI = (*PortalAPICatalogueAPIService)(&c.common)
