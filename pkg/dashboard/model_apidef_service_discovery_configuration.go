...
// checks if the ApidefServiceDiscoveryConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefServiceDiscoveryConfiguration{}

// ApidefServiceDiscoveryConfiguration struct for ApidefServiceDiscoveryConfiguration
type ApidefServiceDiscoveryConfiguration struct {
...
func NewApidefServiceDiscoveryConfiguration() *ApidefServiceDiscoveryConfiguration {
	this := ApidefServiceDiscoveryConfiguration{}
	return &this
}
...
func (o ApidefServiceDiscoveryConfiguration) MarshalJSON() ([]byte, error) {
...
func (o ApidefServiceDiscoveryConfiguration) ToMap() (map[string]interface{}, error) {
...
type NullableApidefServiceDiscoveryConfiguration struct {
	value *ApidefServiceDiscoveryConfiguration
	isSet bool
}

func (v NullableApidefServiceDiscoveryConfiguration) Get() *ApidefServiceDiscoveryConfiguration {
	return v.value
}

func (v *NullableApidefServiceDiscoveryConfiguration) Set(val *ApidefServiceDiscoveryConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefServiceDiscoveryConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefServiceDiscoveryConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefServiceDiscoveryConfiguration(val *ApidefServiceDiscoveryConfiguration) *NullableApidefServiceDiscoveryConfiguration {
	return &NullableApidefServiceDiscoveryConfiguration{value: val, isSet: true}
}

func (v NullableApidefServiceDiscoveryConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefServiceDiscoveryConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
