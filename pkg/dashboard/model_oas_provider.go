...
// checks if the OasProvider type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OasProvider{}

// OasProvider struct for OasProvider
type OasProvider struct {
	ClientToPolicyMapping []OasClientToPolicy `json:"clientToPolicyMapping,omitempty"`
...
// SetClientToPolicyMapping gets a reference to the given []OasClientToPolicy and assigns it to the ClientToPolicyMapping field.
...
func (o OasProvider) MarshalJSON() ([]byte, error) {
...
func (o OasProvider) ToMap() (map[string]interface{}, error) {
...
type NullableOasProvider struct {
	value *OasProvider
	isSet bool
}

func (v NullableOasProvider) Get() *OasProvider {
	return v.value
}

func (v *NullableOasProvider) Set(val *OasProvider) {
	v.value = val
	v.isSet = true
}

func (v NullableOasProvider) IsSet() bool {
	return v.isSet
}

func (v *NullableOasProvider) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOasProvider(val *OasProvider) *NullableOasProvider {
	return &NullableOasProvider{value: val, isSet: true}
}

func (v NullableOasProvider) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOasProvider) UnmarshalJSON(src []byte) error {
	v.isSet = true
