...
type MockResponse struct {
	...
	FromOASExamples NullableFromOASExamples `json:"fromOASExamples,omitempty"`
...
// GetFromOASExamples returns the FromOASExamples field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MockResponse) GetFromOASExamples() FromOASExamples {
	if o == nil || IsNil(o.FromOASExamples.Get()) {
		var ret FromOASExamples
		return ret
	}
	return *o.FromOASExamples.Get()
}
...
// SetFromOASExamples gets a reference to the given NullableFromOASExamples and assigns it to the FromOASExamples field.
func (o *MockResponse) SetFromOASExamples(v FromOASExamples) {
	o.FromOASExamples.Set(&v)
}

// SetFromOASExamplesNil sets the value for FromOASExamples to be an explicit nil
func (o *MockResponse) SetFromOASExamplesNil() {
	o.FromOASExamples.Set(nil)
}
...
func (o MockResponse) ToMap() (map[string]interface{}, error) {
	...
	if o.FromOASExamples.IsSet() {
		toSerialize["fromOASExamples"] = o.FromOASExamples.Get()
	}
	if !IsNil(o.Headers) {
