...
// checks if the OasDomain type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OasDomain{}

// OasDomain struct for OasDomain
type OasDomain struct {
...
func (o OasDomain) MarshalJSON() ([]byte, error) {
...
func (o OasDomain) ToMap() (map[string]interface{}, error) {
...
type NullableOasDomain struct {
	value *OasDomain
	isSet bool
}

func (v NullableOasDomain) Get() *OasDomain {
	return v.value
}

func (v *NullableOasDomain) Set(val *OasDomain) {
	v.value = val
	v.isSet = true
}

func (v NullableOasDomain) IsSet() bool {
	return v.isSet
}

func (v *NullableOasDomain) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOasDomain(val *OasDomain) *NullableOasDomain {
	return &NullableOasDomain{value: val, isSet: true}
}

func (v NullableOasDomain) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOasDomain) UnmarshalJSON(src []byte) error {
	v.isSet = true
