...
// checks if the ApidefVersionDefinition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApidefVersionDefinition{}

// ApidefVersionDefinition struct for ApidefVersionDefinition
type ApidefVersionDefinition struct {
...
func (o ApidefVersionDefinition) MarshalJSON() ([]byte, error) {
...
func (o ApidefVersionDefinition) ToMap() (map[string]interface{}, error) {
...
type NullableApidefVersionDefinition struct {
	value *ApidefVersionDefinition
	isSet bool
}

func (v NullableApidefVersionDefinition) Get() *ApidefVersionDefinition {
	return v.value
}

func (v *NullableApidefVersionDefinition) Set(val *ApidefVersionDefinition) {
	v.value = val
	v.isSet = true
}

func (v NullableApidefVersionDefinition) IsSet() bool {
	return v.isSet
}

func (v *NullableApidefVersionDefinition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApidefVersionDefinition(val *ApidefVersionDefinition) *NullableApidefVersionDefinition {
	return &NullableApidefVersionDefinition{value: val, isSet: true}
}

func (v NullableApidefVersionDefinition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApidefVersionDefinition) UnmarshalJSON(src []byte) error {
	v.isSet = true
