...
// APIClient manages communication with the Tyk Dashboard API API v3.2.0
...
type APIClient struct {
	...
	AdditionalPermissionsApi *AdditionalPermissionsApiService

	AnalyticsApi *AnalyticsApiService

	BasicAuthenticationApi *BasicAuthenticationApiService

	KeysApi *KeysApiService

	OASAPIsApi *OASAPIsApiService

	OpenPolicyAgentApi *OpenPolicyAgentApiService

	PoliciesApi *PoliciesApiService

	SchemaApi *SchemaApiService

	SingleSignOnApi *SingleSignOnApiService
